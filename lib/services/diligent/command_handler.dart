...
typedef CommandHandler<T extends Command> =
    Future<CommandResult> Function(Diligent diligent, T command);

BaseCommandHandler wrapHandler<T extends Command>(CommandHandler<T> handler) {
